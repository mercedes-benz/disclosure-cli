...
var sbomNoticeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		msg := helper.DiscoApiGet(helper.GetProjectVersionAPIURL(conf.DefaultApiVisibility, conf.DefaultApiVersion, projectVersion, "sboms/"+sbomId+"/notice/"+noticeFormat))
