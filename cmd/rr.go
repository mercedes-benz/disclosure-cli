...
var reviewRemarkListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		msg := helper.DiscoApiGet(helper.GetProjectVersionAPIURL(conf.DefaultApiVisibility, conf.DefaultApiVersion, projectVersion, "reviewremarks"))
...
var reviewRemarkCommentCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		msg := helper.DiscoApiPost(helper.GetProjectVersionAPIURL(conf.DefaultApiVisibility, conf.DefaultApiVersion, projectVersion, "reviewremarks/"+rrId), data)
		helper.WriteMessageToOut(cmd, ""+helper.PrettyJSONString(msg))
	},
}
